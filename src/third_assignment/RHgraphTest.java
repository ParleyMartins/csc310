...
/****************************************************************************
 * RHgraphTest.java AUCSC 310 November 4, 2015 Created by R. Heise, exclusively
 * for learning purposes.
 * 
 * Sets up 3 graphs from McConnell, pages 258 to 261 (AUCSC 310 textbook), and
 * finds all articulation points and biconnected components of these graphs.
 * These point and components are found by starting at variety of places in each
 * graph.
 * 
 * Methods available: main() - controls the running of everything: Graph1 ->
 * Graph2 -> Graph3
 * 
...
public class RHgraphTest {
	 ...
	 * 
	 * @param args
	 *            the command line arguments, but NONE are used
	 */
	public static void main(String[] args) {

		System.out.println("Starting graph processing tests for biconnected " + "components");
...
//		myGraph.biConnect(3); // start at D, an AP (root is an AP)
		for (int i = 0; i < myGraph.getNodes().length; i++) {
			System.out.println("================================================");
			System.out.println("=====STARTING AT " + myGraph.getNodes()[i].getLabel());
			myGraph.biConnect(i);
			System.out.println("\n\n\n\n\n");
		}
	}// doGraph1
...
//		myGraph2.biConnect(7); // find APs starting at H
		for (int i = 0; i < myGraph2.getNodes().length; i++) {
			System.out.println("================================================");
			System.out.println("=====STARTING AT " + myGraph2.getNodes()[i].getLabel());
			myGraph2.biConnect(i);
		}
	}// doGraph2
...
//		myGraph3.biConnect(5); // find APs starting at F
		...
		for (int i = 0; i < myGraph3.getNodes().length; i++) {
			System.out.println("================================================");
			System.out.println("=====STARTING AT " + myGraph3.getNodes()[i].getLabel());
			myGraph3.biConnect(i);
		}
	}
}// RHgraphTest class